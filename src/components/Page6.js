...
function Page6() {
  return (
    <div className="pageContainer page-5">
      ...
      <Parallax speed={50} translateX={['-600px', '580px']} className="items">
      ...
      <Parallax speed={50} translateX={['500px', '-480px']} className="items">
      ...
      <Parallax speed={50} translateX={['-400px', '380px']} className="items">
